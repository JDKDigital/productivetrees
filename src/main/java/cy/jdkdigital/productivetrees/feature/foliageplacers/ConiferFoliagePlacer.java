...
public class ConiferFoliagePlacer extends FoliagePlacer
{
    public static final MapCodec<ConiferFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return foliagePlacerParts(instance).and(IntProviders.codec(0, 64).fieldOf("trunk_height").forGetter((placer) -> placer.trunkHeight)).apply(instance, ConiferFoliagePlacer::new);
    });
