...
public class PollenSifterContainer extends AbstractContainer<PollenSifterBlockEntity>
{
    ...
    public PollenSifterContainer(final int windowId, final Inventory playerInventory, final PollenSifterBlockEntity blockEntity) {
        super(TreeRegistrator.POLLEN_SIFTER_MENU.get(), blockEntity, windowId);
        ...
        addSlot(new ManualSlotItemHandler((InventoryHandlerHelper.BlockEntityItemStackHandler) this.getBlockEntity().getItemHandler(), PollenSifterBlockEntity.SLOT_IN, 44, 34));
        addSlot(new ManualSlotItemHandler((InventoryHandlerHelper.BlockEntityItemStackHandler) this.getBlockEntity().getItemHandler(), PollenSifterBlockEntity.SLOT_OUT, 109, 34));
