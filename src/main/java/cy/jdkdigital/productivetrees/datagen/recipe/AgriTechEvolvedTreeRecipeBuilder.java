...
public record AgriTechEvolvedTreeRecipeBuilder(Identifier id, Ingredient sapling, List<Ingredient> soils, List<TreeDropSpec> drops) implements RecipeBuilder
{
    public static AgriTechEvolvedTreeRecipeBuilder tree(Identifier id, Ingredient sapling, List<Ingredient> soils, List<TreeDropSpec> drops) {
        return new AgriTechEvolvedTreeRecipeBuilder(id, sapling, soils, drops);
    }
