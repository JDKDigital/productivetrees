...
public class BlockstateProvider implements DataProvider
{
    ...
    public CompletableFuture<?> run(CachedOutput cache) {
        ...
        TreeRegistrator.BERRIES.forEach(cropConfig ->  {
            generateFruitItem(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, cropConfig.name())), modelOutput);
        });
        ...
        TreeRegistrator.CRATED_CROPS.forEach(crate -> {
            addBlockItemParentModel(BuiltInRegistries.BLOCK.get(crate), "crates/", itemModels);
        });
    ...
    private void addBlockItemModel(Block block, String base, Map<ResourceLocation, Supplier<JsonElement>> itemModels) {
        ...
        if (item != null) {
            addItemModel(item, new DelegatedModel(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/" + base)), itemModels);
        }
    }
    ...
    static class ModelGenerator
    {
        ...
        private void createSapling(TreeObject treeObject) {
            ...
            if (item != Items.AIR) {
                this.modelOutput.accept(ModelLocationUtils.getModelLocation(item), new DelegatedModel(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "item/sapling/base_" + baseSapling + treeObject.getStyle().saplingStyle())));
            }
            this.blockStateOutput.accept(createSimpleBlock(pottedBlock, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/sapling/base_potted_sapling_" + treeObject.getStyle().saplingStyle())));
            this.blockStateOutput.accept(createSimpleBlock(block, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/sapling/base_" + baseSapling + treeObject.getStyle().saplingStyle())));
        }

        static ModelTemplate crateModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/base_crate")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.SIDE, TextureSlot.TOP, TextureSlot.CROP);
        private void createCrate(TreeObject treeObject, Block block) {
            ...
            ResourceLocation top = BuiltInRegistries.BLOCK.getKey(block).withPath((p) -> "block/crate/" + p.replace("_crate", ""));
            var textureMapping = (new TextureMapping())
                    .put(TextureSlot.SIDE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/crate/" + treeObject.getStyle().crateStyle() + "/side"))
                    .put(TextureSlot.TOP, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/crate/" + treeObject.getStyle().crateStyle() + "/top"))
                    .put(TextureSlot.BOTTOM, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/crate/" + treeObject.getStyle().crateStyle() + "/bottom"))
        ...
        private void createBaseBlock(Block block, String baseName) {
            this.blockStateOutput.accept(createSimpleBlock(block, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/" + baseName)));
        }
        ...
        private void createFruitBlock(TreeObject treeObject) {
            this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(TreeUtil.getBlock(treeObject.getId(), "_fruit")).with(PropertyDispatch.property(ProductiveFruitBlock.getAgeProperty()).generate(age -> {
                ...
                if (fruitStyle.equals("default")) {
                    var template = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fruit/base_fruit")), Optional.empty(), TextureSlot.ALL, TextureSlot.PLANT);
        ...
        private void createCrate(TreeObject treeObject, ResourceLocation item) {
            var cratePath = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, item.withPath(p -> p.equals("apple") ? "red_delicious_apple_crate" : p + "_crate").getPath());
            if (TreeRegistrator.CRATED_CROPS.contains(cratePath) && !treeObject.getId().getPath().contains("copper_beech") && !treeObject.getId().getPath().contains("purple_blackthorn")) {
                createCrate(treeObject, BuiltInRegistries.BLOCK.get(cratePath));
            }
            ...
            if (TreeRegistrator.CRATED_CROPS.contains(roastedCratePath) && !treeObject.getId().getPath().contains("copper_beech") && !treeObject.getId().getPath().contains("purple_blackthorn")) {
                createCrate(treeObject, BuiltInRegistries.BLOCK.get(roastedCratePath));
            };
        }

        private void createStairsBlock(WoodObject treeObject) {
            Block block = TreeUtil.getBlock(treeObject.getId(), "_stairs");
            ResourceLocation stairs = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + treeObject.getStyle().plankStyle() + "_stairs");
            ResourceLocation stairsInner = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + treeObject.getStyle().plankStyle() + "_stairs_inner");
            ResourceLocation stairsOuter = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + treeObject.getStyle().plankStyle() + "_stairs_outer");
        ...
        private void createSlabBlock(WoodObject treeObject) {
            ...
            ResourceLocation slab = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/slab/" + treeObject.getStyle().plankStyle() + "_slab");
            ResourceLocation planks = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + treeObject.getStyle().plankStyle());
            ResourceLocation slabTop = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/slab/" + treeObject.getStyle().plankStyle() + "_slab_top");
        ...
        private void createPressurePlateBlock(WoodObject treeObject) {
            ...
            ResourceLocation plate = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/pressure_plate/" + treeObject.getStyle().plankStyle() + "_pressure_plate");
            ResourceLocation plateDown = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/pressure_plate/" + treeObject.getStyle().plankStyle() + "_pressure_plate_down");
        ...
        private void createButtonBlock(WoodObject treeObject) {
            ...
            ResourceLocation button = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + treeObject.getStyle().plankStyle() + "_button");
            ResourceLocation buttonPressed = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + treeObject.getStyle().plankStyle() + "_button_pressed");
        ...
        private void createFenceGateBlock(WoodObject treeObject) {
            ...
            ResourceLocation fenceGate = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + treeObject.getStyle().plankStyle() + "_fence_gate");
            ResourceLocation fenceGateOpen = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + treeObject.getStyle().plankStyle() + "_fence_gate_open");
            ResourceLocation fenceGateWall = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + treeObject.getStyle().plankStyle() + "_fence_gate_wall");
            ResourceLocation fenceGateWallOpen = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + treeObject.getStyle().plankStyle() + "_fence_gate_wall_open");
        ...
        private void createFenceBlock(WoodObject treeObject) {
            ...
            ResourceLocation fencePost = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + treeObject.getStyle().plankStyle() + "_fence_post");
            ResourceLocation fenceSide = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + treeObject.getStyle().plankStyle() + "_fence_side");
            this.blockStateOutput.accept(
        ...
        private void createDoorBlock(WoodObject treeObject) {
            ...
            ResourceLocation bottomLeft = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_bottom_left");
            ResourceLocation bottomLeftOpen = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_bottom_left_open");
            ResourceLocation bottomRight = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_bottom_right");
            ResourceLocation bottomRightOpen = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_bottom_right_open");
            ResourceLocation topLeft = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_top_left");
            ResourceLocation topLeftOpen = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_top_left_open");
            ResourceLocation topRight = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_top_right");
            ResourceLocation topRightOpen = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + treeObject.getStyle().doorStyle() + "_top_right_open");
        ...
        private void createTrapdoorBlock(WoodObject treeObject) {
            ...
            ResourceLocation top = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + treeObject.getStyle().doorStyle() + "_top");
            ResourceLocation bottom = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + treeObject.getStyle().doorStyle() + "_bottom");
            ResourceLocation open = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + treeObject.getStyle().doorStyle() + "_open");
        ...
        private void createBaseModels() {
            WoodSet.STYLES.forEach((name, style) -> {
                ...
                var planksModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + modelPrefix + "base_planks")), Optional.empty(), TextureSlot.ALL);

                var buttonModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + modelPrefix + "base_button")), Optional.empty(), TextureSlot.TEXTURE);
                var buttonInventoryModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + modelPrefix + "base_button_inventory")), Optional.empty(), TextureSlot.TEXTURE);
                var buttonPressedModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + modelPrefix + "base_button_pressed")), Optional.empty(), TextureSlot.TEXTURE);

                var fenceInventoryModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + modelPrefix + "base_fence_inventory")), Optional.empty(), TextureSlot.TEXTURE);
                var fencePostModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + modelPrefix + "base_fence_post")), Optional.empty(), TextureSlot.TEXTURE);
                var fenceSideModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + modelPrefix + "base_fence_side")), Optional.empty(), TextureSlot.TEXTURE);

                var fenceGateModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + modelPrefix + "base_fence_gate")), Optional.empty(), TextureSlot.TEXTURE);
                var fenceGateOpenModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + modelPrefix + "base_fence_gate_open")), Optional.empty(), TextureSlot.TEXTURE);
                var fenceGateWallModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + modelPrefix + "base_fence_gate_wall")), Optional.empty(), TextureSlot.TEXTURE);
                var fenceGateWallOpenModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + modelPrefix + "base_fence_gate_wall_open")), Optional.empty(), TextureSlot.TEXTURE);

                var pressurePlateModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/pressure_plate/" + modelPrefix + "base_pressure_plate")), Optional.empty(), TextureSlot.TEXTURE);
                var pressurePlateDownModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/pressure_plate/" + modelPrefix + "base_pressure_plate_down")), Optional.empty(), TextureSlot.TEXTURE);

                var slabModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/slab/" + modelPrefix + "base_slab")), Optional.empty(), TextureSlot.TEXTURE);
                var slabTopModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/slab/" + modelPrefix + "base_slab_top")), Optional.empty(), TextureSlot.TEXTURE);

                var stairsModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + modelPrefix + "base_stairs")), Optional.empty(), TextureSlot.TEXTURE);
                var stairsInnerModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + modelPrefix + "base_stairs_inner")), Optional.empty(), TextureSlot.TEXTURE);
                var stairsOuterModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + modelPrefix + "base_stairs_outer")), Optional.empty(), TextureSlot.TEXTURE);

                var leavesModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/leaves/" + modelPrefix + "base_leaves")), Optional.empty(), TextureSlot.ALL);

                var logModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + modelPrefix + "base_log")), Optional.empty(), TextureSlot.END, TextureSlot.SIDE);
                var logHorizontalModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + modelPrefix + "base_log_horizontal")), Optional.empty(), TextureSlot.END, TextureSlot.SIDE);
                var cubeColumnModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/" + modelPrefix + "cube_column")), Optional.empty(), TextureSlot.END, TextureSlot.SIDE);
                var cubeColumnHorizontalModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/" + modelPrefix + "cube_column_horizontal")), Optional.empty(), TextureSlot.END, TextureSlot.SIDE);

                var doorBottomLeftModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "bottom_left")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorBottomLeftOpenModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "bottom_left_open")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorBottomRightModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "bottom_right")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorBottomRightOpenModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "bottom_right_open")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorTopLeftModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "top_left")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorTopLeftOpenModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "top_left_open")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorTopRightModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "top_right")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);
                var doorTopRightOpenModel = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + modelPrefix + "top_right_open")), Optional.empty(), TextureSlot.BOTTOM, TextureSlot.TOP);

                var trapdoorBottom = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + modelPrefix + "template_orientable_trapdoor_bottom")), Optional.empty(), TextureSlot.TEXTURE);
                var trapdoorOpen = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + modelPrefix + "template_orientable_trapdoor_open")), Optional.empty(), TextureSlot.TEXTURE);
                var trapdoorTop = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + modelPrefix + "template_orientable_trapdoor_top")), Optional.empty(), TextureSlot.TEXTURE);

                var bookshelf = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/" + modelPrefix + "base_bookshelf")), Optional.empty(), TextureSlot.SIDE);

                var sign = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/sign/" + modelPrefix + "base_sign")), Optional.empty(), TextureSlot.PARTICLE);
                var hangingSign = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/sign/" + modelPrefix + "base_sign")), Optional.empty(), TextureSlot.PARTICLE);

                var plankTextureMap = (new TextureMapping()).put(TextureSlot.TEXTURE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + style.plankStyle())).put(TextureSlot.ALL, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + style.plankStyle()));
                // planks
                planksModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + name), plankTextureMap, this.modelOutput);
                // button
                buttonModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + name + "_button"), plankTextureMap, this.modelOutput);
                buttonInventoryModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + name + "_button_inventory"), plankTextureMap, this.modelOutput);
                buttonPressedModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/button/" + name + "_button_pressed"), plankTextureMap, this.modelOutput);
                // fence
                fenceInventoryModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + name + "_fence_inventory"), plankTextureMap, this.modelOutput);
                fencePostModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + name + "_fence_post"), plankTextureMap, this.modelOutput);
                fenceSideModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence/" + name + "_fence_side"), plankTextureMap, this.modelOutput);
                // fence_gate
                fenceGateModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + name + "_fence_gate"), plankTextureMap, this.modelOutput);
                fenceGateOpenModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + name + "_fence_gate_open"), plankTextureMap, this.modelOutput);
                fenceGateWallModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + name + "_fence_gate_wall"), plankTextureMap, this.modelOutput);
                fenceGateWallOpenModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/fence_gate/" + name + "_fence_gate_wall_open"), plankTextureMap, this.modelOutput);
                // pressure_plate
                pressurePlateModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/pressure_plate/" + name + "_pressure_plate"), plankTextureMap, this.modelOutput);
                pressurePlateDownModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/pressure_plate/" + name + "_pressure_plate_down"), plankTextureMap, this.modelOutput);
                // slab
                slabModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/slab/" + name + "_slab"), plankTextureMap, this.modelOutput);
                slabTopModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/slab/" + name + "_slab_top"), plankTextureMap, this.modelOutput);
                // stairs
                stairsModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + name + "_stairs"), plankTextureMap, this.modelOutput);
                stairsInnerModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + name + "_stairs_inner"), plankTextureMap, this.modelOutput);
                stairsOuterModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stairs/" + name + "_stairs_outer"), plankTextureMap, this.modelOutput);

                // leaves
                var leavesTextureMap = (new TextureMapping()).put(TextureSlot.ALL, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/leaves/" + style.leafStyle()));
                leavesModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/leaves/" + name), leavesTextureMap, this.modelOutput);

                var logTextureMap = (new TextureMapping())
                        .put(TextureSlot.END, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log_top/" + style.woodStyle()))
                        .put(TextureSlot.SIDE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + style.woodStyle()));

                logModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + name + "_log"), logTextureMap, this.modelOutput);
                logHorizontalModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + name + "_log_horizontal"), logTextureMap, this.modelOutput);

                var strippedLogTextureMap = (new TextureMapping())
                        .put(TextureSlot.END, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stripped/" + style.woodStyle() + "_top"))
                        .put(TextureSlot.SIDE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stripped/" + style.woodStyle()));

                cubeColumnModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + name + "_stripped_log"), strippedLogTextureMap, this.modelOutput);
                cubeColumnHorizontalModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + name + "_stripped_log_horizontal"), strippedLogTextureMap, this.modelOutput);

                var strippedWoodTextureMap = (new TextureMapping())
                        .put(TextureSlot.END, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stripped/" + style.woodStyle()))
                        .put(TextureSlot.SIDE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stripped/" + style.woodStyle()));

                cubeColumnModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + name + "_stripped_wood"), strippedWoodTextureMap, this.modelOutput);

                var woodTextureMap = (new TextureMapping())
                        .put(TextureSlot.END, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + style.woodStyle()))
                        .put(TextureSlot.SIDE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + style.woodStyle()));

                cubeColumnModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/log/" + name + "_wood"), woodTextureMap, this.modelOutput);

                var doorTextureMap = (new TextureMapping())
                        .put(TextureSlot.TOP, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + style.doorStyle() + "_top"))
                        .put(TextureSlot.BOTTOM, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + style.doorStyle() + "_bottom"));

                doorBottomLeftModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_bottom_left"), doorTextureMap, this.modelOutput);
                doorBottomLeftOpenModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_bottom_left_open"), doorTextureMap, this.modelOutput);
                doorBottomRightModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_bottom_right"), doorTextureMap, this.modelOutput);
                doorBottomRightOpenModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_bottom_right_open"), doorTextureMap, this.modelOutput);
                doorTopLeftModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_top_left"), doorTextureMap, this.modelOutput);
                doorTopLeftOpenModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_top_left_open"), doorTextureMap, this.modelOutput);
                doorTopRightModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_top_right"), doorTextureMap, this.modelOutput);
                doorTopRightOpenModel.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/door/" + name + "_top_right_open"), doorTextureMap, this.modelOutput);

                var trapdoorTextureMap = (new TextureMapping())
                        .put(TextureSlot.TEXTURE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + style.doorStyle()));

                trapdoorBottom.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + name + "_bottom"), trapdoorTextureMap, this.modelOutput);
                trapdoorOpen.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + name + "_open"), trapdoorTextureMap, this.modelOutput);
                trapdoorTop.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/trapdoor/" + name + "_top"), trapdoorTextureMap, this.modelOutput);

                var bookshelfTextureMap = (new TextureMapping()).put(TextureSlot.SIDE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + style.plankStyle()));

                bookshelf.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/bookshelf/" + name), bookshelfTextureMap, this.modelOutput);

                var signTextureMap = (new TextureMapping()).put(TextureSlot.TEXTURE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/planks/" + style.plankStyle()));
                var hangingSignTextureMap = (new TextureMapping()).put(TextureSlot.TEXTURE, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/stripped/" + style.plankStyle()));

                sign.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/sign/" + name), signTextureMap, this.modelOutput);
                hangingSign.create(ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, "block/sign/hanging_" + name), hangingSignTextureMap, this.modelOutput);
            });
        }
        ...
        class WoodProvider
        {
            ...
            public WoodProvider wood(String style, Block block, boolean stripped) {
                ModelGenerator.this.blockStateOutput.accept(ModelGenerator.createAxisAlignedPillarBlock(block, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, stripped ? "block/log/" + style + "_stripped_wood" : "block/log/" + style + "_wood")));
                return this;
            }
            ...
            public WoodProvider logWithHorizontal(String style, Block block, boolean stripped, String type) {
                ResourceLocation rLoc = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, stripped ? "block/log/" + style + "_stripped_" + type : "block/log/" + style + "_" + type);
                ResourceLocation rLocHor = ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, stripped ? "block/log/" + style + "_stripped_" + type + "_horizontal" : "block/log/" + style + "_" + type + "_horizontal");
                ModelGenerator.this.blockStateOutput.accept(ModelGenerator.createRotatedPillarWithHorizontalVariant(block, ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, rLoc.getPath()), ResourceLocation.fromNamespaceAndPath(ProductiveTrees.MODID, rLocHor.getPath())));
                return this;
            }
        }
    }
